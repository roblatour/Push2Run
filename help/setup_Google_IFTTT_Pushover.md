...
|     |     |
| --- | --- |
|     | 1\. Google Home, Google Mini, Google Max, or smart phone running Google Assistant  <br>  <br>2\. Windows computer  <br>  <br>3\. (free or paid) account with [Pushover](https://pushover.net/)  <br>  <br>4\. (free) copy of [Push2Run](https://github.com/roblatour/Push2Run)  <br>  <br>5\.   an [IFTTT](https://ifttt.com) Pro / Pro+ Account (note: an IFTTT PRO account allows you to create up to and including 20 applets (one needed for each Push2Run commands) while a Pro+ account allows you to create unlimited applets. |
